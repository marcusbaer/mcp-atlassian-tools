...
async function main() {
  ...
  server.tool(
    ...
    async ({ pageId, expand }) =>
      asText(await client.getPageById(pageId, expand)),
  );
  server.tool(
    ...
    async ({ title, spaceKey, limit }) =>
      asText(await client.getPageByTitle(title, spaceKey, limit)),
  );
  server.tool(
    ...
    async ({ pageId, limit, start }) =>
      asText(await client.listPageChildren(pageId, limit, start)),
  );
  server.tool(
    ...
    async ({ pageId, limit, start }) =>
      asText(await client.listAttachments(pageId, limit, start)),
  );
  server.tool(
    ...
    async ({ pageId, limit, start }) =>
      asText(await client.listLabels(pageId, limit, start)),
  );
  server.tool(
